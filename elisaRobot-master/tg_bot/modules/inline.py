...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        {
            "title": " “info” Account info on Elisa • オーディン",
            "description": "Look up a Telegram account in Elisa • オーディン database",
            "message_text": "Click the button below to look up a person in Elisa • オーディン database using their Telegram ID",
            "thumb_urL": "https://te.legra.ph/file/59765e59b65dc7f4183a4.jpg",
            "keyboard": "info ",
        },
        {
            "title": " “about” About",
            "description": "Know about Elisa • オーディン",
            "message_text": "Click the button below to get to know about elisa • オーディン.",
            "thumb_urL": "https://te.legra.ph/file/59765e59b65dc7f4183a4.jpg",
            "keyboard": "about ",
        },
        {
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Report Error", url='https://t.me/Elisha_support'
                ),
                InlineKeyboardButton(
                    text="Search again",
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    about_text = f"""
    Elisa• オーディン (@{context.bot.username})
    Maintained by [ルーク](t.me/denvil_pro)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Support",
                    url=f"https://t.me/Elisha_support",
                ),
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/denvil_bots",
                ),
                InlineKeyboardButton(
                    text="Maintainer",
                    url=f"https://t.me/denvil_pro",
                ),
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About Elisa • オーディン (@{context.bot.username})",
